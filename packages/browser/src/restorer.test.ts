  ...
  return {
    ...
    validateManifestVersion: (manifest: { version: string }) => {
      if (/^0\.[0-2]\./.test(manifest.version)) {
        throw new Error(
          "Cannot restore manifests generated by pixzle v0.2.x or older. Please re-shuffle the original images with pixzle v0.3.0 or newer.",
        );
      }
    },
  };
...
describe("ImageRestorer", () => {
  ...
  it("should reject manifests generated by v0.2.x or older before restoring", async () => {
    ...
    await expect(
      ...
      "Cannot restore manifests generated by pixzle v0.2.x or older.",
    );
